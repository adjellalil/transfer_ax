...
def parse_args(argv=None) -> argparse.Namespace:
    ...
    parser.add_argument("--source-parc", required=True, type=Path,
                        help="Fichier PARC_CLIENT (CSV) - source principale (obligatoire)")
    parser.add_argument("--source-cm360", required=True, type=Path,
                        help="Fichier CM360 (CSV) (obligatoire)")
    parser.add_argument("--source-prgm", required=True, type=Path,
                        help="Fichier PRGM_CONSOLIDE Worldline (CSV) (obligatoire)")
    parser.add_argument("--opti", required=True, type=Path,
