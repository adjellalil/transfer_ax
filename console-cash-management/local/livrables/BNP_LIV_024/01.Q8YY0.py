...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--wl-prgm", required=True, metavar="PATH",
                   help="Fichier WORLDLINE PRGM (source CPC) [obligatoire]")
    p.add_argument("--mx-monext", required=True, metavar="PATH",
                   help="Fichier MONEXT (source CCO) [obligatoire]")
    p.add_argument("--ref-client", required=True, metavar="PATH",
                   help="Fichier REFERENTIEL CLIENT [obligatoire]")
    p.add_argument("--idseg", required=True, metavar="PATH",
                   help="Fichier IDENTIFIANT-SEGMENT [obligatoire]")
    p.add_argument("--parc", required=True, metavar="PATH",
                   help="Fichier PARC_CLIENT [obligatoire]")
    p.add_argument("--account", required=True, metavar="PATH",
                   help="Fichier IBAN_ACCOUNT [obligatoire]")
    p.add_argument("--devises", required=True, metavar="PATH",
                   help="Fichier DEVISES [obligatoire]")
    p.add_argument("--monitoring", required=True, metavar="PATH",
