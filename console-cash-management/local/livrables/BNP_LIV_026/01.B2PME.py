...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--parc", required=True, help="PARC_CLIENT (obligatoire)")
    p.add_argument("--flux-amount", required=True,
                   help="FLUX AMOUNT agrégé [N3096] (obligatoire)")
    p.add_argument("--flux-number", required=True,
                   help="FLUX NUMBER agrégé [N3096] (obligatoire)")
    p.add_argument("--flux-interchange", required=True,
                   help="FLUX INTERCHANGE agrégé [N3096] (obligatoire)")
    p.add_argument("--stock", required=True, help="STOCK agrégé [66Z3Q] (obligatoire)")
    p.add_argument("--worldline", required=True,
                   help="WORLDLINE PRGM consolidé [6AICC] (obligatoire)")
    p.add_argument("--monext", required=True,
