...
def build_parser() -> argparse.ArgumentParser:
    ...
    req.add_argument("--source",       required=True, help="00. MONITORING_CIB / ONBORDING (base a enrichir).")
    req.add_argument("--worldline",    required=True, help="05. PRGM Worldline (flux CPC).")
    req.add_argument("--monext",       required=True, help="04. MONEXT (flux CCO).")
    req.add_argument("--account",      required=True, help="01. IBAN_ACCOUNT (pivot priorite 1).")
    req.add_argument("--ref-client",   required=True, help="02. REFERENTIEL_CLIENT (pivot priorite 2).")
    req.add_argument("--idseg",        required=True, help="03. IDENTIFIANT_SEGMENT (pivot priorite 3).")
    req.add_argument("--devises",      required=True, help="09. DEVISES (Date YYYYMM | Code | Taux vers EUR).")
    req.add_argument("--type-of-card", required=True, help="08. CLEAN_TYPE_OF_CARD (Type Original -> New).")
