...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--parc", required=True, type=Path,
                        help="(obligatoire) Fichier PARC_CLIENT (source SME), CSV.")
    parser.add_argument("--monext", required=True, type=Path,
                        help="(obligatoire) Fichier MONEXT consolide - CORPORATE, CSV.")
    parser.add_argument("--worldline", required=True, type=Path,
