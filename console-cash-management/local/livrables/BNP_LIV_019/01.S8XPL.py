...
def build_parser() -> argparse.ArgumentParser:
    ...
    # Sources requises
    parser.add_argument("--monext", required=True, type=Path, help="(oblig) Fichier MONEXT consolide (CSV)")
    parser.add_argument("--ref-client", required=True, type=Path, help="(oblig) Referentiel client (fichier Olivier)")
    parser.add_argument("--parc", required=True, type=Path, help="(oblig) PARC_CLIENT")
    parser.add_argument("--opti", required=True, type=Path, help="(oblig) OPTIFLUX")
    parser.add_argument("--yannick", required=True, type=Path, help="(oblig) Gestion Directe/Indirecte")
    parser.add_argument("--geo", required=True, type=Path, help="(oblig) BG_LE_RMPM_COUNTRY")
