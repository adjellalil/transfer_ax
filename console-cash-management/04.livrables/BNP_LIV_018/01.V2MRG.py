...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--prgm", type=Path, required=False, default=None, help="Fichier PRGM Worldline source (obligatoire)")
    p.add_argument("--ref-client", type=Path, required=False, default=None, help="Fichier REFERENTIEL CLIENT / Olivier (obligatoire)")
    p.add_argument("--segment", type=Path, required=False, default=None, help="Fichier IDENTIFIANT-SEGMENT (obligatoire)")
    p.add_argument("--parc", type=Path, required=False, default=None, help="Fichier PARC_CLIENT (obligatoire)")
    p.add_argument("--opti", type=Path, required=False, default=None, help="Fichier OPTIFLUX (obligatoire)")
    p.add_argument("--yannick", type=Path, required=False, default=None, help="Fichier YANNICK gestion directe/indirecte (obligatoire)")
    p.add_argument("--devises", type=Path, required=False, default=None, help="Fichier DEVISES Date|Devise|Taux (obligatoire)")
    p.add_argument("--account", type=Path, required=False, default=None, help="Fichier BG-LE-RMPM ACCOUNT (obligatoire)")
...
def main(argv=None) -> int:
    ...
    try:
        ...
        if not args.segment:
            args.segment = resolve_source("IDENTIFIANT_SEGMENT", required=True)
        if not args.parc:
