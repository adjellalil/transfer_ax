...
def main(argv: Optional[list] = None) -> int:
    ...
    parser.add_argument(
        "--source-monext-detail", required=False, default=None, type=Path,
    ...
    try:
        if not args.source_monext_detail:
            args.source_monext_detail = resolve_source("MONEXT_DETAIL_K2P8N", required=True)
