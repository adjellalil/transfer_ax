...
def main() -> int:
    ...
    parser.add_argument("--source-prgm", required=False, default=None, help="Fichier PRGM Worldline (41 colonnes) [OBLIGATOIRE]")
    parser.add_argument("--source-acheteur", required=False, default=None, help="Fichier ACHETEUR Casper/Noyan (72 colonnes) [OBLIGATOIRE]")
    ...
    try:
        ...
        if not args.source_acheteur:
            args.source_acheteur = resolve_source("FICHIER_ACHETEUR", required=True)
        app = App(args)
        res = app.run()
