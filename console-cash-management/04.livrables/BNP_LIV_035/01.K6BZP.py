...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--worldline", required=False, default=None, type=Path,
                   help="00. Fichier PRGM Worldline (flux CPC).")
    p.add_argument("--monext", required=False, default=None, type=Path,
                   help="01. Fichier MONEXT (flux CCO).")
    p.add_argument("--account", required=False, default=None, type=Path,
                   help="02. Fichier IBAN_ACCOUNT (pivot 1).")
    p.add_argument("--ref-client", required=False, default=None, type=Path,
                   help="03. Fichier REFERENTIEL_CLIENT (pivot 2).")
    p.add_argument("--idseg", required=False, default=None, type=Path,
                   help="04. Fichier IDENTIFIANT_SEGMENT (pivot 3).")
    p.add_argument("--devises", required=False, default=None, type=Path,
                   help="05. Fichier DEVISES (conversion -> EUR).")
    p.add_argument("--rebate", required=False, default=None, type=Path,
                   help="06. Fichier REBATE (Année | RMPM | Plateforme | Montant).")
    p.add_argument("--country", required=False, default=None, type=Path,
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    try:
        # Auto-résolution des sources OBLIGATOIRES depuis 03.sources/*/<SOURCE>
        ...
        if not args.rebate:
            args.rebate = resolve_source("REBATE", required=True)
        if not args.country:
            args.country = resolve_source("COUNTRY", required=True)
